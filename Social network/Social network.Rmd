...
En el siguiente trabajo realizaremos un analisis para ver cómo están conectados los usuarios que mencionan a las vacunas Pfizer y SputnikV dentro de la red social de Twitter.
...
Hacemos un gráfico para ver las comunidades
